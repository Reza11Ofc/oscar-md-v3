...
let hallo = fs.readFileSync('mp3/haigabut.opus') 
...
handler.customPrefix = /^(hi|hii|hiii|hi bot|tes|tes|hy|halo|hallo|helo|hello|hy eza|halo eza|bot|helo bot|hello bot)$/i
